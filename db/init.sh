...
mysql -uisucon -h 172.17.147.2 torb -e 'INSERT INTO sheetcounts (event_id, `rank`, count) VALUES (11, "S", 0), (11, "A", 0), (11, "B", 0), (11, "C", 0), (12, "S", 0), (12, "A", 0), (12, "B", 0), (12, "C", 0), (13, "S", 0), (13, "A", 0), (13, "B", 0), (13, "C", 0)'
mysql -uisucon -h 172.17.147.2 torb -e 'UPDATE sheets SET `order` = ROUND(RAND() * 5000)'
